...
var yScale = d3.scaleLinear().domain([0, 40]).range([0, 300]);

var colorScale = d3.scaleLinear().domain([0, d3.max(dataset)]).range(['PaleTurquoise', 'Blue']);
...
svg.selectAll('rect').data(dataset).enter().append('rect').attr('class', 'bar').attr('x', function (d, index) {
  ...
  return yScale(d);
}).attr('fill', colorScale).on('mouseover', function (d, index) {
...
},{"d3":11}],515:[function(require,module,exports) {
...
//# sourceMappingURL=/app.9e72f52e.map