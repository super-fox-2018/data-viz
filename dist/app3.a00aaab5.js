...
},{"./dist/package":17,"d3-array":19,"d3-axis":10,"d3-brush":20,"d3-chord":21,"d3-collection":22,"d3-color":23,"d3-contour":24,"d3-dispatch":25,"d3-drag":26,"d3-dsv":27,"d3-ease":28,"d3-fetch":18,"d3-force":29,"d3-format":30,"d3-geo":31,"d3-hierarchy":32,"d3-interpolate":33,"d3-path":34,"d3-polygon":35,"d3-quadtree":36,"d3-random":37,"d3-scale":38,"d3-scale-chromatic":39,"d3-selection":40,"d3-shape":41,"d3-time":42,"d3-time-format":43,"d3-timer":44,"d3-transition":45,"d3-voronoi":46,"d3-zoom":47}],6:[function(require,module,exports) {
'use strict';
...
var svg = d3.select('#chartArea').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.left + margin.right).append('g').attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
d3.csv('IMDB-Movie-Data.csv').then(function (response) {
  ...
  var colorScale = d3.scaleLinear().domain([5, d3.max(data, function (d) {
    return d.Rating;
  ...
  svg.selectAll('.bar').data(data).enter().append('rect').attr('class', 'bar').attr('x', function (d) {
    ...
    div.html(d.Title + "<br/>" + d.Rating).style("left", d3.event.pageX + "px").style("top", d3.event.pageY - 28 + "px");
...
},{"d3":11}],516:[function(require,module,exports) {
...
//# sourceMappingURL=/app3.a00aaab5.map