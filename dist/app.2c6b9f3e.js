...
d3.csv("WorldCups.csv").then(function (data) {
  ...
  svg.selectAll(".bar").data(data).enter().append("rect").attr('class', 'char').attr("x", function (d) {
    return x(d.Year);
    ...
    div.html("year : " + d.Year + "<br/>" + "goals : " + d.GoalsScored).style("left", d3.event.pageX + "px").style("top", d3.event.pageY - 28 + "px");
...
//# sourceMappingURL=/app.2c6b9f3e.map